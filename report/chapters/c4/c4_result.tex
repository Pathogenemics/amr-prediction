...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/recall_by_scope}
\caption{Recall comparison across antibiotics and determinant-connection scopes.}
\label{fig:recall-by-scope}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/precision_by_scope}
\caption{Precision comparison across antibiotics and determinant-connection scopes.}
...
The three plots reveal the same underlying pattern from different angles. Recall highlights where broader evidence is needed to recover resistant isolates. Precision highlights whether a wide scope is overcalling resistance. ROC-AUC then shows whether the model is still separating resistant and susceptible isolates well across thresholds even when the exact operating point differs.
