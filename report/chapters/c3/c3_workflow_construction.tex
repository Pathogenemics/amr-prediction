...
Several biologically meaningful edge cases required explicit manual support before the \texttt{unknown} fallback. In particular, \texttt{rifampin} was mapped to \texttt{rifamycin}, \texttt{clindamycin} was mapped to \texttt{lincosamide}, and \texttt{trimethoprim-sulfamethoxazole} was decomposed into \texttt{trimethoprim} and \texttt{sulfonamide}.
...
\caption{Illustrative broad-scope hierarchy for beta-lactam antibiotics.}
